...
public class PessoaDAO {
    ...
    public List<Pessoa> findAllCli() {
        Query q = session.createQuery("from Pessoa where pes_tipo = 1");
        return q.list();
    }
    public List<Pessoa> findAllForn() {
        Query q = session.createQuery("from Pessoa where pes_tipo = 2");
        return q.list();
    }
    public List<Pessoa> findAllVend() {
        Query q = session.createQuery("from Pessoa where pes_tipo = 3");
        return q.list();
    }
